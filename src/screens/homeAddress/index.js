...
onHomeChange(text) {
  ...
  render() {
    return (
        ...
        <View style = {{
          ...
          <Form>
            ...
            >
              ...
              placeholder = 'Home Address' onChangeText = {this.onHomeChange.bind(this)} />
      ...
      {this.props.pickup !== ''  && !this.props.geocoding && this.props.pickup_coords != null &&
        ...
        <View style = {{
          ...
          onPress = {() => this.props.navigation.navigate('WorkAddress')}>
            <Text>PROCEED</Text>
          </Button>
        </View>
        }
