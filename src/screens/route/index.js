...
import { View, Image, TextInput, StatusBar, StyleSheet, Dimensions, Platform , TouchableOpacity} from "react-native";
  ...
  reload() {
	...
	render() {
		...
		<Header style = {{borderBottomColor: "#22313F", borderBottomWidth: 1, backgroundColor: "#22313F"}} >
					...
					<Body>
            <Title style = {{color: '#FFF',  fontFamily: 'Montserrat'}}>Routes</Title>
          ...
          <List
                      ...
                      //     </Right>
										...
										// 			marginTop: 10
										// 		}}> 
										// 			<View style = {{height: 8, width: 8, marginTop: 3, backgroundColor: '#22A7F0'}}></View>
										// 			<Text  style = {{
										// 				 fontFamily: 'Montserrat',
										// 				 color: '#777',
										// 				 fontSize: 12,
										...
										// 			marginTop: 10
										// 		}}> 
										// 			<View style = {{height: 8, width: 8, marginTop: 3, backgroundColor: '#000'}}></View>
										// 			<Text  style = {{
										// 				 fontFamily: 'Montserrat',
										// 				 color: '#777',
										// 				 fontSize: 12,
