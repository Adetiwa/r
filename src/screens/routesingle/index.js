...
addWeekdays(date, days) {
  ...
  enterAction() {
    if (thissingle2.length > 0 && thissingle2[0].payment_status == 'active') {
        alert("You already have an active ticket for this route");
              ...
              alignContent: 'center',
                ...
                <TouchableOpacity  onPress = {() => this.setState({isDateTimePickerVisible: true})}><Text style={{color: '#4CAF50',fontSize: 14,
                 ...
                 paddingBottom: 10,
                    ...
                    textAlign: 'center',
                    fontSize: 15,
                    }}>{this.state.startDay} </Text></TouchableOpacity>
                </View>
