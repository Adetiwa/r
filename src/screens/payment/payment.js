...
class Payment extends Component {
	...
	componentWillMount(){
	  ...
	  movetostuff() {
		if (!this.props.card_exist){
			...
			this.setState({msg: 'You need to add a card to fund your wallet'})
        } else {
	...
	<StatusBar backgroundColor="#22313F" barStyle="light-content" />
				...
				<Header androidStatusBarColor="#22313F"  style = {{borderBottomColor: "#22313F", borderBottomWidth: 1, backgroundColor: "#22313F"}} >
					...
					<Body>
            <Title style = {{color: '#FFF',  fontFamily: 'Montserrat-Regular'}}>Payment</Title>
            ...
            <Button transparent
				...
				<Content>
					<Separator bordered style = {{
						...
						<ListItem
							button onPress={() => this.movetostuff()}>
