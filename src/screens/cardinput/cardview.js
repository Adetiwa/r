      ...
      <View style={styles.container}>
        ...
        <Header androidStatusBarColor="#22313F"  style = {{borderBottomColor: "#22313F", borderBottomWidth: 1, backgroundColor: "#22313F"}} >
            <Left>
                ...
                <Icon style = {{color : "#FFF", fontSize: 40, fontFamily: 'Montserrat-Regular'}}  size = {40} name="arrow-back" />
                </TouchableOpacity>

            </Left>

            <Body>
            <Title style = {{color: '#FFFF', fontWeight: '100',fontFamily: 'Montserrat-Regular',
									}}>Payment</Title>
...
const styles = StyleSheet.create({
    ...
    textError: {
        // fontFamily: "Montserrat-Regular-Light",
        // //alignSelf: 'center',
        // marginTop: 20,
        // justifyContent:'center',
        // alignItems: 'center',
